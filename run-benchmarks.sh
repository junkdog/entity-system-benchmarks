...
java -jar entreri-1.7.0/target/microbenchmarks.jar -o results/artemis-0.6.5-bench.csv -rf csv
java -jar gdx-artemis-0.5.0/target/microbenchmarks.jar -o results/artemis-0.6.5-bench.csv -rf csv
