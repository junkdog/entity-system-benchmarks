...
public class PooledComponentBenchmark extends JmhSettings {
	...
	public void init() {
		...
		worldPlain.setSystem(new PooledPositionSystem());
		worldPlain.setSystem(new EntityDeleterSystem(JmhSettings.SEED, entityCount, PooledPosition.class, PooledStructComponentA.class));
