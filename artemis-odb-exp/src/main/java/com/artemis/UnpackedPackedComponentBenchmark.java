...
import com.artemis.system.UnpackedPositionSystem;
import com.github.esfbench.JmhSettings;

public class UnpackedPackedComponentBenchmark extends JmhSettings {
	...
	public void init() {
		...
		worldPacked.setSystem(new UnpackedPositionSystem());
