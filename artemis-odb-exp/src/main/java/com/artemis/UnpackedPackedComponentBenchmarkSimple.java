...
import com.artemis.system.UnpackedPositionSystemSimple;
import com.github.esfbench.JmhSettings;

public class UnpackedPackedComponentBenchmarkSimple extends JmhSettings {
	...
	public void init() {
		...
		worldPacked.setSystem(new UnpackedPositionSystemSimple());
		worldPacked.setSystem(new EntityDeleterSystem(JmhSettings.SEED, entityCount, UnpackedPositionSimple.class, PlainStructComponentA.class));
